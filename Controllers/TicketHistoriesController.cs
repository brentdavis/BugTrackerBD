...
namespace BugTrackerBD.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,DateChanged,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,DateChanged,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
